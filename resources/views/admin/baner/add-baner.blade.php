        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form action="{{url('app/store/baner')}}" id="wizard_with_validation" method="POST" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            <h3>Info</h3>
                            <fieldset>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="slika" class="form-control" required>
