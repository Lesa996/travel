...
@section('content')
    ...
    <div class="">
        <ul class="nav nav-tabs nav-bar-putovanja">
            <li class="active"><a href="#Informacije" data-toggle="tab"><i class="glyphicon glyphicon-list-alt"></i> Informacije</a></li>
            <li><a href="#Cenovnik" data-toggle="tab" ><i class="glyphicon glyphicon-eur"></i> Cenovnik</a></li>
        ...
        <div class="tab-content clearfix">
            <div class="tab-pane active" id="Informacije">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSekWQ54JyyBrggP9B_gD_BvnXNR73b8BXqMz9Gb4P6PQ_DA8w/viewform?embedded=true" width="auto" height="500" frameborder="0" marginheight="1" marginwidth="1">Loading...</iframe>
                        </div>
                    </div>
            ...
            <div class="tab-pane" id="Cenovnik">
                <h3>CEN Content's background color is the same for the tab</h3>
            </div>
